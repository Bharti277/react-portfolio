...
const About = () => {
  return (
    <div className='about_container'>
      <p className="context">
        I'm a react web developer with 3+ years of experience in web development. I love creating responsive websites using React/Redux, JavaScript, HTML5, CSS3, Bootstrap, and Sass/Scss. 
